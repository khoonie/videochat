...
import 'package:videochat/authentication/palette.dart';
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/images/Living 6.png"),
                      fit: BoxFit.fill)),
              child: Container(
                padding: EdgeInsets.only(top: 90, left: 20),
                color: Color.fromARGB(255, 88, 110, 160).withOpacity(.35),
                child: Column(
                  ...
                  children: [
                    RichText(
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: isSignupScreen ? " Seeker," : " Back, ",
                              style: TextStyle(
                                fontSize: 25,
                  ...
                  child: Column(
                    ...
                    children: [
                      SignInButton(Buttons.Apple,
                          onPressed: () {}, text: 'Sign Up with Apple'),
  ...
  Container buildSigninSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(
              Icons.mail_outline, "youremail@seeker.com", false, true),
          buildTextField(
